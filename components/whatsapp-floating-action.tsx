...
export function WhatsAppFloatingAction() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-5 right-5 z-[70] flex size-14 items-center justify-center rounded-full bg-white shadow-[0_12px_32px_rgba(0,0,0,0.18)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_40px_rgba(0,0,0,0.22)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#25D366] md:bottom-8 md:right-8"
    >
